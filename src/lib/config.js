...
export const RECEIVING_ADDRESSES = {
  BTC: process.env.NEXT_PUBLIC_BTC_ADDRESS || 'bc1qr63h7nzs0lhzumk2stg7fneymwceu2y7erd96l',
  USDT: process.env.NEXT_PUBLIC_USDT_ADDRESS || 'TQbchYKr8FbXCVPNTtDVdrfGYKiUnkJVnY',
  ETH: process.env.NEXT_PUBLIC_ETH_ADDRESS || '0x2499aDe1b915E12819e8E38B1d9ed3493107E2B1'
};
